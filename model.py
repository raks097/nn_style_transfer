...
def build_model(input_img,model_weights,pool_type):
  ...
  net['pool1']   = pool_layer('pool1', net['relu1_2'],pool_type)
  ...
  net['pool2']   = pool_layer('pool2', net['relu2_2'],pool_type)
  ...
  net['pool3']   = pool_layer('pool3', net['relu3_4'],pool_type)
  ...
  net['pool4']   = pool_layer('pool4', net['relu4_4'],pool_type)
  ...
  net['pool5']   = pool_layer('pool5', net['relu5_4'],pool_type)
